# docker build --build-arg USER=goldfita --build-arg VERSION=29.2 -f emacs.Dockerfile -t emacs .
...
RUN apt install -o DPkg::Options::="--force-confnew" -y python3 ispell fonts-hack-ttf ripgrep markdown && \
    ln -s "${HOME}/.emacs.d/git"  "/home/${USER}/git" && \
    ln -s "${HOME}/.emacs.d/rg"   "/home/${USER}/rg" && \
    ln -s "${HOME}/.emacs.d/java" "/home/${USER}/java" && \
    fc-cache -f
